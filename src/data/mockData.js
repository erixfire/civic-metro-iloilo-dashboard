...
export const WEATHER = {
  ...
  temp: 34,
  feelsLike: 41,
  heatIndex: 41,         // °C — PAGASA April 27 bulletin: Iloilo City 41°C (Extreme Caution)
...
// PAGASA April 27 heat index bulletin: Dumangas, Iloilo 45°C (DANGER)
// Iloilo City 41°C (EXTREME CAUTION) — Inquirer/GMA Network/PAGASA
export const HEAT_INDEX_ILOILO = [
  { area: 'Dumangas, Iloilo',   hiC: 45, level: 'Danger',           levelColor: 'text-red-600',    bg: 'bg-red-50 dark:bg-red-950/40',    note: 'Heat cramps/exhaustion likely; heat stroke possible with prolonged exposure.' },
  ...
  { area: 'Lambunao, Iloilo',   hiC: 40, level: 'Caution',          levelColor: 'text-yellow-500', bg: 'bg-yellow-50 dark:bg-yellow-950/40', note: 'Fatigue possible with prolonged exposure; watch for heat cramps.' },
]
...
export const HEAT_INDEX_NEWS = [
  {
    ...
    summary: 'Dumangas, Iloilo logged the highest heat index at 45°C. PAGASA warns of heat cramps, exhaustion, and heat stroke risk.',
  ...
  },
  {
    ...
    date: '2026-04-27',
    source: 'Inquirer.net',
    title: 'Heat, thunderstorms expected across Visayas — PAGASA',
  ...
  },
  {
    ...
    summary: 'Dumangas, Iloilo at 45°C and Iloilo City at 43°C among the top spots in the April 25 PAGASA bulletin.',
  ...
  },
  {
    ...
    date: '2026-04-10',
    source: 'GMA Network',
    title: 'Heat index in Dumangas, Iloilo reaches 44°C on April 10',
    summary: 'PAGASA logged the highest heat index in PH at Dumangas — 44°C Danger level. Heat exhaustion likely with prolonged exposure.',
  ...
  },
  {
    ...
    title: 'Heat Index Forecast: Iloilo City expected to reach 38°C on April 1–2',
    summary: 'Based on DOST-PAGASA forecast, Iloilo City heat index was expected to reach 38°C. Public advised to minimize outdoor activity.',
